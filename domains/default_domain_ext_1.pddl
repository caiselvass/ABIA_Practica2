(define (domain reading_plan)
    (:requirements :typing :negative-preconditions :existential-preconditions :disjunctive-preconditions :fluents)
    ...
    (:action assign_book
        ...
        :precondition (and
            ...
            (not (exists (?pre - book) (and (predecessor ?pre ?b) (or (not (read ?pre)) (assigned ?pre ?actualm)))))
        )
        :effect (and
            (read ?b)
            (assigned ?b ?actualm)
