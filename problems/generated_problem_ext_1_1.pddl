(define (problem reading_plan_problem_ext_1_1)
	(:domain reading_plan)
	;;Objects
	(:objects
	...
	(:init
		...
		(previous_month Past)
		;;Predecessos
		(predecessor Book_2 Book_1)
		(predecessor Book_3 Book_1)
		(predecessor Book_4 Book_1)
		(predecessor Book_5 Book_1)
		(predecessor Book_6 Book_3)
		(predecessor Book_7 Book_2)
		(predecessor Book_8 Book_1)
